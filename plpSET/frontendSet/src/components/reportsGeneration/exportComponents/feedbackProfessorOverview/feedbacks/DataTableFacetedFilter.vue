  ...
  <Popover>
    <PopoverTrigger as-child>
      <Button
        variant="outline"
        size="sm"
        class="h-8 border-dashed text-darks-200/90 text-sm px-4"
      >
        <CirclePlus class="pr-2 h-4 w-4" />
        {{ title }}
    ...
    <PopoverContent class="w-[200px] p-0" align="start">
      ...
      >
        <CommandInput
          :placeholder="title"
          class="focus:outline-none focus:ring-0 focus:border-transparent active:outline-none active:border-transparent"
        />
        <CommandList>
          ...
          <CommandGroup>
            ...
            >
              <div
                :class="
                  cn(
                    'mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-black/15',
                    selectedValues.has(option.value)
                      ? 'bg-black text-white'
