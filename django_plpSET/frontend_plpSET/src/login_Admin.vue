...
<template>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <section class="bg-yellow-50 rounded-lg px-5 font-raleway ">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
                <div class="flex flex-col justify-center">
                    <h1 class="mb-4 text-md font-black tracking-tight leading-none text-green-700 md:text-5xl lg:text-4xl">
                ...
                <div>
                    <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl">
                        ...
                        <form action="" method="POST" class="mt-8 space-y-6">
                            <div>
                                <label for="username" class="block mb-2 text-sm font-medium xt-gray-900">Username</label>
                            ...
                            <button type="submit" class="w-full px-5 py-3 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-600 focus:ring-4 focus:ring-blue-300 sm:w-auto">Login to your account</button>
                        </form>
                    </div>
                </div>
            </div>
