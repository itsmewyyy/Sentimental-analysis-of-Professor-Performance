...
<template>
  <div class="relative">
    <div
      ...
      class="absolute flex justify-between px-4 top-3 z-[1]"
    >
      <button
        :class="
          cn(
...
.vc-popover-content-wrapper .vc-popover-content {
  @apply mt-3 rounded-md max-w-full border bg-white; /* Replace bg-background with bg-white */
}
...
.vc-popover-content-wrapper .vc-nav-items .vc-nav-item:hover {
  @apply text-gray-600 bg-gray-200; /* Replace text-muted-foreground with text-gray-600 and bg-muted with bg-gray-200 */
}
.vc-popover-content-wrapper .vc-nav-items .vc-nav-item.is-active {
  @apply bg-plpgreen-200 text-white; /* Replace bg-primary and text-primary-foreground with bg-blue-500 and text-white */
}
...
.calendar .vc-weekday {
  @apply text-gray-600 rounded-md font-normal text-[0.8rem]; /* Replace text-muted-foreground with text-gray-600 */
}
.calendar .vc-weeks {
...
.calendar .vc-day.is-today:not(:has(.vc-day-layer)) .vc-day-content {
  @apply bg-plpyellow-200 text-white rounded-md; /* Replace bg-secondary with bg-green-500 */
}
...
.calendar .vc-day-content {
  @apply text-center text-sm p-0 relative focus-within:relative focus-within:z-20 inline-flex items-center justify-center ring-offset-white hover:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-plpyellow-100/40 focus-visible:ring-offset-2 hover:bg-plpyellow-100/20 hover:text-plpyellow-200 h-9 w-9 font-normal aria-selected:opacity-100 select-none; /* Replace ring-offset-background and hover:bg-accent */
}
...
.calendar .vc-disabled {
  @apply text-gray-600 opacity-50; /* Replace text-muted-foreground with text-gray-600 */
}
.calendar .vc-highlight-content-solid,
.calendar .vc-highlight-content-outline {
  @apply bg-plpgreen-400 text-white hover:bg-plpgreen-400 focus:bg-plpgreen-400; /* Replace bg-primary and text-primary-foreground */
}
.calendar .vc-highlight-content-light {
  @apply bg-yellow-200 text-yellow-800; /* Replace bg-accent and text-accent-foreground */
}
...
.vc-time-picker.vc-attached {
  @apply border-t border-solid border-gray-300 mt-2; /* Replace border-secondary with border-gray-300 */
}
.vc-time-picker > * + * {
  @apply mt-1;
}
...
.vc-time-select-group {
  @apply inline-flex items-center px-1 rounded-md bg-white border border-solid border-gray-300; /* Replace bg-primary-foreground with bg-white and border-secondary with border-gray-300 */
}
.vc-time-select-group .vc-base-icon {
  @apply mr-1 text-blue-500 stroke-blue-500; /* Replace text-primary with text-blue-500 */
}
.vc-time-select-group select {
  @apply bg-white p-1 appearance-none outline-none text-center; /* Replace bg-primary-foreground with bg-white */
}
.vc-time-weekday {
  @apply text-gray-600 tracking-wide; /* Replace text-muted-foreground with text-gray-600 */
}
.vc-time-month {
  @apply text-blue-500 ml-2; /* Replace text-primary with text-blue-500 */
}
.vc-time-day {
  @apply text-blue-500 ml-1; /* Replace text-primary with text-blue-500 */
}
.vc-time-year {
  @apply text-gray-600 ml-2; /* Replace text-muted-foreground with text-gray-600 */
}
</style>
